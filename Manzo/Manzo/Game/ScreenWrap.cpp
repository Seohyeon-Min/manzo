...
void ScreenWrap::Update([[maybe_unused]] double dt) {
    ivec2 frame_size = object.GetGOComponent<Sprite>()->GetFrameSize();
    ...
    if (object.GetPosition().x > Engine::window_width + object.GetGOComponent<Sprite>()->GetFrameSize().x / 2.0f) {
