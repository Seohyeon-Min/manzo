...
//}
//
//void Logger::WriteSaveFile(std::map<int, int> fishCollection, int money, bool module1_buy, bool module1_set, float m1x, bool module2_buy, bool module2_set, float m2x)
//{
