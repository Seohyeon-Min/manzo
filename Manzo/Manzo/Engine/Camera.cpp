...
{
    caminfo.camera_view.SetFramebufferSize((int)Engine::window_width*10, (int)Engine::window_height*10 );
    ...
    std::cout << "Camera pos: " << caminfo.camera.Position.x << ", " << caminfo.camera.Position.y << "\n";
